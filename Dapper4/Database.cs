...
namespace Dapper
{
    ...
    public class Database : IDatabase
    {
        ...
        public IEnumerable<T> GetList<T>(object predicate, IList<ISort> sort, int? commandTimeout = null, bool buffered = true) where T : class
        {
        ...
        public IEnumerable<T> GetPage<T>(object predicate, IList<ISort> sort, int page, int resultsPerPage, int? commandTimeout = null, bool buffered = true) where T : class
        {
        ...
        public IEnumerable<T> GetSet<T>(object predicate, IList<ISort> sort, int firstResult, int maxResults, int? commandTimeout = null, bool buffered = true) where T : class
        {
            return _dapper.GetSet<T>(Connection, predicate, sort, firstResult, maxResults, _transaction, commandTimeout, buffered);
        }

        public int Count<T>(object predicate, IDbTransaction transaction, int? commandTimeout = null) where T : class
        {
